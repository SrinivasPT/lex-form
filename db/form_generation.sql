...
DECLARE @formCode VARCHAR(128) = 'control_form'; -- Replace with the desired form code
        ...
        SELECT
            ...
            JSON_QUERY((
                SELECT
                    ...
                    -- For table controls, include rowConfig
                    -- (SELECT JSON_QUERY((
                    --     SELECT
                    --         c3.code,
                    --         c3.[key],
                    ...
                    --     FOR JSON PATH
                    -- )) WHERE c2.type = 'table') AS rowConfig,
                    -- For group controls, include controls
                    (SELECT JSON_QUERY((
                        SELECT
                            c3.code,
                            c3.[key],
